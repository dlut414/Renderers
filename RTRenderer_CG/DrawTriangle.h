...
public:
    ...
    void draw()
    {
        ...
        glUniform3f(glGetUniformLocation(shaderObj.programID[0], "pMin"), box.pMin.x, box.pMin.y, box.pMin.z);
        glUniform3f(glGetUniformLocation(shaderObj.programID[0], "pMax"), box.pMax.x, box.pMax.y, box.pMax.z);
        ...
        //glDrawArrays(/*GL_TRIANGLES*/GL_POINTS, 0, numVert);
