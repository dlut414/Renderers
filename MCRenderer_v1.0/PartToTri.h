...
private:
    ...
    inline void vertexInterp2(Point& edge, const Point& v1, const Point& v2) const
    {
    ...
    void buildTri()
    {
        ...
        for(unsigned i=0; i<numCube; i++)
        {
            ...
            vertexInterp2(_edge[0], vert[_id[0]], vert[_id[1]]);
            vertexInterp2(_edge[1], vert[_id[1]], vert[_id[2]]);
            vertexInterp2(_edge[2], vert[_id[2]], vert[_id[3]]);
            vertexInterp2(_edge[3], vert[_id[3]], vert[_id[0]]);

            vertexInterp2(_edge[4], vert[_id[4]], vert[_id[5]]);
            vertexInterp2(_edge[5], vert[_id[5]], vert[_id[6]]);
            vertexInterp2(_edge[6], vert[_id[6]], vert[_id[7]]);
            vertexInterp2(_edge[7], vert[_id[7]], vert[_id[4]]);

            vertexInterp2(_edge[8], vert[_id[0]], vert[_id[4]]);
            vertexInterp2(_edge[9], vert[_id[1]], vert[_id[5]]);
            vertexInterp2(_edge[10], vert[_id[2]], vert[_id[6]]);
            vertexInterp2(_edge[11], vert[_id[3]], vert[_id[7]]);

            Vector _norm[12];

            normInterp2(_norm[0], vertNorm[_id[0]], vertNorm[_id[1]]);
            normInterp2(_norm[1], vertNorm[_id[1]], vertNorm[_id[2]]);
            normInterp2(_norm[2], vertNorm[_id[2]], vertNorm[_id[3]]);
            normInterp2(_norm[3], vertNorm[_id[3]], vertNorm[_id[0]]);

            normInterp2(_norm[4], vertNorm[_id[4]], vertNorm[_id[5]]);
            normInterp2(_norm[5], vertNorm[_id[5]], vertNorm[_id[6]]);
            normInterp2(_norm[6], vertNorm[_id[6]], vertNorm[_id[7]]);
            normInterp2(_norm[7], vertNorm[_id[7]], vertNorm[_id[4]]);

            normInterp2(_norm[8], vertNorm[_id[0]], vertNorm[_id[4]]);
            normInterp2(_norm[9], vertNorm[_id[1]], vertNorm[_id[5]]);
            normInterp2(_norm[10], vertNorm[_id[2]], vertNorm[_id[6]]);
            normInterp2(_norm[11], vertNorm[_id[3]], vertNorm[_id[7]]);
