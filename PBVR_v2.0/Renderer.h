...
void InitOBJ()
{
    ...
    cube_obj    ->  build();
    part_obj    ->  genPart_MP(cube_obj);

    std::cout << "# of vertex: " << cube_obj->vert.size() << std::endl;
    std::cout << "# of particle: " << part_obj->numPart << std::endl;
    std::cout << "boundary1: " << cube_obj->box.pMin.x << " " << cube_obj->box.pMin.y << " " << cube_obj->box.pMin.z << " " << std::endl;
    std::cout << "boundary2: " << cube_obj->box.pMax.x << " " << cube_obj->box.pMax.y << " " << cube_obj->box.pMax.z << " " << std::endl;

    g_InitialCameraPosition = glm::vec3((cube_obj->box.pCenter()).x, (cube_obj->box.pCenter()).z, 0.05f);
