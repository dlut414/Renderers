...
public:
    Controller(int i) : i_file(i)
    {
        ...
        m_initCameraPosition = glm::vec3(0.f, 0.025f, 0.2f);
        m_initCameraRotation = glm::angleAxis<float>( -Common::PI * 0.f, glm::vec3(1, 0, 0) );
        ...
        m_camera.SetProjectionRH    (45.0f, 1.0f, f_near, f_far);
    }
    ~Controller() {}
