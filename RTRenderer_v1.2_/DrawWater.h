...
public:
    ...
    void init(float _pointSize, unsigned _numBBVert, Point* _BBVertPos, unsigned _numVolVert, Point* _volPos, Vector* _volNorm, float* _volData)
    {
    ...
    void draw(GLuint& bgTex)
    {
        ...
        glUniformMatrix4fv( glGetUniformLocation(shaderObj.programID[0], "vMv"), 1, GL_FALSE, &(Draw_::stateObj->m_viewModelMat[0][0]) );
        glUniformMatrix4fv( glGetUniformLocation(shaderObj.programID[0], "fPro"), 1, GL_FALSE, &(Draw_::stateObj->m_projectionMat[0][0]) );
        glUniformMatrix4fv( glGetUniformLocation(shaderObj.programID[0], "fProInv"), 1, GL_FALSE, &(Draw_::stateObj->m_projectionMatInv[0][0]) );
        glUniform1f(glGetUniformLocation(shaderObj.programID[0], "radius"), pointSize);
        glUniform1f(glGetUniformLocation(shaderObj.programID[0], "height"), float(Draw_::stateObj->u_height));
        ...
        glDrawArrays(GL_POINTS, 0, numBBVert);
        ...
        glUniformMatrix4fv( glGetUniformLocation(shaderObj.programID[1], "vMv"), 1, GL_FALSE, &(Draw_::stateObj->m_viewModelMat[0][0]) );
        glUniformMatrix4fv( glGetUniformLocation(shaderObj.programID[1], "fPro"), 1, GL_FALSE, &(Draw_::stateObj->m_projectionMat[0][0]) );
        glUniformMatrix4fv( glGetUniformLocation(shaderObj.programID[1], "fProInv"), 1, GL_FALSE, &(Draw_::stateObj->m_projectionMatInv[0][0]) );
        glUniform1f(glGetUniformLocation(shaderObj.programID[1], "radius"), pointSize);
        glUniform1f(glGetUniformLocation(shaderObj.programID[1], "height"), float(Draw_::stateObj->u_height));
        ...
        glUniformMatrix4fv( glGetUniformLocation(shaderObj.programID[2], "fMv"), 1, GL_FALSE, &(Draw_::stateObj->m_viewModelMat[0][0]) );
        glUniformMatrix4fv( glGetUniformLocation(shaderObj.programID[2], "fPro"), 1, GL_FALSE, &(Draw_::stateObj->m_projectionMat[0][0]) );
        glUniformMatrix4fv( glGetUniformLocation(shaderObj.programID[2], "fProInv"), 1, GL_FALSE, &(Draw_::stateObj->m_projectionMatInv[0][0]) );
        glUniform1f(glGetUniformLocation(shaderObj.programID[2], "radius"), pointSize);
        glUniform1f(glGetUniformLocation(shaderObj.programID[2], "height"), float(Draw_::stateObj->u_height));
