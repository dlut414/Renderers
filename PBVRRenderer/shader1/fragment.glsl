...
void main()
{
    ...
    if(vertColor < 0.5f) color = vec4( 2.f* (0.5f-vertColor) * vec3(0.f, 0.f, 1.f) + 2.f* vertColor*vec3(0.f, 1.f, 0.f), 1.f);
    else                 color = vec4( 2.f* (1.f-vertColor) * vec3(0.f, 1.f, 0.f) + 2.f* (vertColor-0.5f)*vec3(1.f, 0.f, 0.f), 1.f);
